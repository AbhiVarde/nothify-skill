...
Agent skill for generating production-ready custom 404 pages in any Next.js project.
...
Once installed, ask your agent to add a 404 page to any Next.js project:
...
The skill reads your project files, detects the full stack, adapts the chosen template, and writes the file to the correct path.

## Templates

Six templates, each available in light and dark variants. Preview all at [nothify.abhivarde.in](https://nothify.abhivarde.in).
...
| Language      | Checks `tsconfig.json`, `.ts`/`.tsx` files, dependencies |
